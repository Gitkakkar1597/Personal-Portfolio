...
document.addEventListener("DOMContentLoaded", function() {
  ...
  applyStylesheet('styles/lightMode.css');
});
...
function toggleMode() {
  ...
  if (isDarkMode) {
      ...
      modeToggleButton.classList.remove('dark-mode');
      applyStylesheet('styles/lightMode.css');
  } else {
      body.classList.add('dark-mode');
      modeToggleButton.classList.add('dark-mode');
      applyStylesheet('styles/darkMode.css');
  }
}

function applyStylesheet(filename) {
  // Remove existing stylesheet, if any
  var oldLink = document.getElementById("mode-stylesheet");
  if (oldLink) {
